...
function setup() {
  ...
  //ground1 = new Base(0, height - 10, width * 2, 10, "#795548", true);
  //ground2 = new Base(0, height - 10, width * 2, 10, "#795548", true);
  leftWall = new Base(80, height / 2 + 3, 600, 100, "#8d6e63", true);
  rightWall = new Base(width - 700, height / 2 + 3, 600, 100, "#8d6e63", true);
